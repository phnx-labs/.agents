...
- **Cut a ticket.** Use `/tickets` to open one scoped to the fix: the delta, the root-cause file:line, the regression test to add, and the spec gap. Link the artifact.
