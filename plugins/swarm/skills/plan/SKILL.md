...
Publish plans with `artifacts render --publish` to a private managed URL. Keep
plans outside the repo unless they ship with a feature code change; then commit
them through that feature worktree and PR.
