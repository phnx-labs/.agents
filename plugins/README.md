...
| [`design`](./design/README.md) | 5 | One keyless, offline-first front door for design — `/design` routes an intent, `/design:system`/`/design:graphics`/`/design:prototype`/`/design:critique` are direct doors to the four focused skills, all rendering self-contained HTML/SVG |
