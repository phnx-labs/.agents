...
| Publish HTML artifact | **share** | `/share` (`--private` for unlisted) |
...
| [`share`](./share/README.md) | 1 | Publish agent-generated HTML to a link on your own Cloudflare R2 — `/share` (auto OG cover), `/share --private` (unlisted, expiring, no cover) |
