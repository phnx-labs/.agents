...
| --- | --- |
| `/share <file>` | Publish a **public** link with an auto-generated OG cover (a screenshot of the page's hero), so it unfurls into a preview card in Slack / iMessage / Twitter/X / Discord. Default slug `<project>-<feature>-<hash>`. |
...
`/share plan.html` publishes the page and auto-generates a cover from its hero,
