...
gate-outcome-backfill.py|offline analysis of already-recorded gate telemetry; deliberately never on a hook path, run by hand or by `agents hooks gates report`
'
