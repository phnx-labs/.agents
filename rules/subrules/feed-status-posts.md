...
```bash
agents feed post --title "<short subject>" "<one human line — what just happened>"
```
...
```bash
agents feed post --title "Signing needs you" "production signing needs your biometric" --blocked
```
