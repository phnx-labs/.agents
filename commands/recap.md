...
2. **Record follow-ups in the one owner update.** Anything you were about to write as
   "we should also…" or "worth revisiting…" is a line in the summary; deliverable work
   goes through the `tickets` skill, one ticket per unit of delivery, not one per file.
   The summary links whatever ids exist. If a follow-up doesn't earn a line, drop it.
