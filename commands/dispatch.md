...
needs a concrete target, unlike `/work:loop triage` which defaults to the whole board.)

This is the single-task counterpart to `/work:loop triage` (which sweeps the whole board). Use this
