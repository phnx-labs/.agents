...
**`/loop` is an alias of `/work:loop`.** General-purpose unattended drain — not
engineering-only. Full procedure lives in the `work:loop` skill.

Invoke the `work:loop` skill. Arguments: $ARGUMENTS
