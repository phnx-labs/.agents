...
- **`code-quality` now names conceptual simplicity as the bar, and comments as a
  ...
  count — and agents generate ideas for free, so concept sprawl is the limit that
  bites; documentation earns its place only for a genuinely new core concept), and
