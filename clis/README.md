...
| [`term`](./term.yaml) | Standalone PTY engine (`@phnx-labs/term-cli`); the interactive-terminal tool `agents fleet login` spawns and the account-setup flows drive (`agents pty` was removed, PHNX-4091). `agents setup term` installs it |
