...
def derive(data):
    out = {
        ...
        # Opt-in gate for the feed-forward hook: forward deliberate `agents feed
        # post` status updates to the owner's phone. OFF by default.
        "forward_status": data.get("forward_status", False),
        "name": data.get("name", ""),
